...
const OFFLINE_APP_SHELL = [
  ...
  "./roulette-offline-queue.js?v=3",
  "./buffalo-service.js?v=6",
  "./pwa-service.js?v=1",
  "./push-service.js?v=2",
  "./shortcut-service.js?v=8",
  "./dice-service.js?v=3",
  ...
  "./trottl-special-fish-count.js?v=3",
  "./trottl-special-catch-me.js?v=3",
  "./trottl-special-debug.js?v=1",
  "./trottl-special-finale.js?v=1",
  "./trottl-special-ui.js?v=27",
  "./trottl-special-admin.js?v=1",
  "./button-release.js?v=1",
  "./team-division-v2-logic.js?v=2",
  "./script.js?v=108",
  "./tournament-create.js?v=8",
