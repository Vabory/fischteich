...
-- LEAST is PostgreSQL conditional syntax, not a schema-qualified function.
-- Recreate only the group-aware overload with an unqualified LEAST call.
