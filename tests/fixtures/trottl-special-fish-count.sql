...
begin
 ...
 for seed in 1..140 loop
  ...
  if duration not between 2000 and 4000 then raise exception 'Reveal duration outside range';end if;
 ...
 if public.special_fish_count_reveal_ms(5)<>2000 or public.special_fish_count_reveal_ms(18)<>4000 then raise exception 'Reveal duration endpoints wrong';end if;
