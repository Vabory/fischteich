...
test("status, provision and revoke repair identity and send the persisted Bearer JWT", async () => {
  ...
  assert.deepEqual(harness.ensureProfileCalls, ["Fabian", "Fabian", "Fabian"]);
