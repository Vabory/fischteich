...
test("HTML parent hierarchy equals deployment 257 apart from build and CSS/UI cache metadata", () => {
  const html=read("index.html")
    .replace(/^    <(?:script|link)[^\n]*trottl-special[^\n]*\n/gm, "")
    .replace(/^    <link rel="preload" as="image" href="\.\/assets\/mini-games\/lachs-fish\.png">\n/m, "")
  ...
  assert.equal(hash(html),"8d01184ce5e2f44205c1f152d598c4eecb4066a5c93b2840ceaeacae40e46868",reference);
});
