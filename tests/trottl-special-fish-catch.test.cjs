...
test("versioned fish/debug load after shell before Special UI; unchanged Zahl/PANIK/Roulette assets retain cache",()=>{
 const html=read("index.html");for(const [file,v]of [["trottl-special-service.js",10],["trottl-special-ui.js",10],["trottl-special.css",9],["trottl-special-minigames.js",2],["trottl-special-fish-catch.js",1],["trottl-special-debug.js",1],["trottl-special-number-hunt.js",2],["trottl-special-panic.js",1],["trottl-special-roulette.js",1]])assert.ok(html.includes(`${file}?v=${v}`));
