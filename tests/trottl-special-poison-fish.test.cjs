...
test("large shell, field clipping, normalized hitbox and wiring leave older games untouched", () => {
  ...
  const html = read("index.html"); for (const part of ["trottl-special-poison-fish.js?v=4","trottl-special-minigames.js?v=9","trottl-special-service.js?v=23","trottl-special-ui.js?v=27","trottl-special.css?v=34"]) assert.ok(html.includes(part));
