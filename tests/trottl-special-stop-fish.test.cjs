...
test("cache versions advance only the Stop Fish controller and shared CSS", () => { const html = read("index.html"); assert.match(html, /trottl-special-stop-fish\.js\?v=5/); assert.match(html, /trottl-special-fish-memory\.js\?v=5/); assert.match(html, /trottl-special\.css\?v=34/); assert.match(html, /trottl-special-minigames\.js\?v=9/); assert.match(html, /trottl-special-service\.js\?v=23/); assert.match(html, /trottl-special-ui\.js\?v=27/); });
