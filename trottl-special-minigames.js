...
(function installSpecialMinigames(global) {
  const registry = Object.freeze(Array.from({ length: 10 }, (_, i) => Object.freeze({
    id: `special_minigame_${String(i + 1).padStart(2, "0")}`, active: i < 8, implemented: i < 8, title: ["Zahlenjagd", "Fischfang", "Reaktionstest", "Farbenchaos", "Fisch-Memory", "Stop den Fisch", "Giftfisch", "Fische zählen"][i] ?? null,
  })));
